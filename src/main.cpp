...
int main(int argc, char const** argv)
{
    ...
    */
    ...
    bot.on_ready([&bot](const dpp::ready_t & event){
        ...
        {
            dpp::slashcommand joincommand("join", "Присоединиться к гол. каналу", bot.me.id);
            dpp::slashcommand playcommand("play", "Играет песню из yt", bot.me.id);
